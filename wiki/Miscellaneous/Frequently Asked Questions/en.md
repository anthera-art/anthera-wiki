...
- ## Is AI-generated content permitted?
In almost all cases: NO.

There are some more nuanced rules to this, but a blanket rule is that you should NOT upload any AI generated content. Please read the [Content Rules](/wiki/Rules_and_Guidelines/Content_Rules) for more infomation.

- ## What is UNTONE ID/UNTONE Account?
When I started making websites, I created a shared account system called UNTONE ID which works using oauth, so I could stop worrying about developing login systems, and focus on making the site itself. As such, most of my websites, including Anthera, use this as login.

It's entirely made and owned by us, so don't worry!
...
- ## Does Anthera have a mascot?
Not yet! We're working on a silly fox :3

- ## Where are text uploads?
Coming soon! We used to have support, but it ran away. We're still looking for it.